...
class TableStaffs(models.Model):
    STAFF_TYPE = (("permanent", "Permanent"),("temporary", "Temporary"),)
    ...
    staff_type = models.CharField(max_length=20,choices=STAFF_TYPE,default="permanent")
    monthly_salary = models.FloatField(null=True, blank=True)
    daily_wage = models.FloatField(null=True, blank=True)
    date=models.DateField(null=True)
...
class WeeklyWork(models.Model):
    staff = models.ForeignKey(TableStaffs, on_delete=models.CASCADE)
