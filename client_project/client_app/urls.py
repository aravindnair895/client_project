...
urlpatterns=[
    ...
    path("generate_msalary/",views.generate_msalary),
    path("generate_tsalary/",views.generate_tsalary),
    path("delete_staffsalary/<int:salary_id>/", views.delete_staffsalary),
    path("salary_slip/<salary_id>/", views.generate_salary_slip),
